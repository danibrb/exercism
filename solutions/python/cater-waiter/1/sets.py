...
def categorize_dish(dish_name, dish_ingredients):
    ...
    dish_type = "OMNIVORE"
    if dish_ingredients.issubset(VEGAN): dish_type = "VEGAN"
    elif dish_ingredients.issubset(VEGETARIAN): dish_type = "VEGETARIAN"
    elif dish_ingredients.issubset(PALEO): dish_type = "PALEO"
    elif dish_ingredients.issubset(KETO): dish_type = "KETO"
